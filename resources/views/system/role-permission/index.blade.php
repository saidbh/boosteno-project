            ...
            <div class="iq-header-title w-100">
              <div class="row">
                <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a href="{{route('system-role-permission.create')}}" class="btn btn-primary">Ajouter Rôle</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <tr class="text-center">
                    ...
                    <td>
                      <div class="flex align-items-center list-user-action">
                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Modifier rôle {{$value['name']}}" href="{{route('system-role-permission.edit',[$value->id])}}"><i class="ri-pencil-line"></i></a>
                        <a data-toggle="modal" data-target="#role{{$value['id']}}" data-placement="top" title="" data-original-title="Supprimer rôle {{$value['name']}}" href="#"><i class="ri-delete-bin-line"></i></a>
                            ...
                            <form method="POST" action="{{route('system-role-permission.destroy',[$value->id])}}">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="staticBackdropLabel">Supprimer rôle {{$value['name']}}</h5>
