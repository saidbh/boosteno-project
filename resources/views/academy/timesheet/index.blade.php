                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="table-responsive">
                                <table id="timesheet-table" class="table table-striped table-bordered mt-4" role="grid"
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <span data-toggle="modal" data-target="#Del">
                                                        <a data-toggle="tooltip" data-placement="top" title=""
                                                            data-original-title="Archiver" href="#"><i
                                            ...
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Ajouter Timesheets
                                                        </h5>
                                                            ...
                                                            <form action="#" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <select name="Class" id="Class_update"
                                                                            class="form-control" required>
                                                                            <option selected value=""> ...</option>
                                                                            <option value="1"> 1</option>
                                                                            <option value="2"> 2</option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <input name="hour_rate" type="number"
                                                                            class="form-control" id="hour_rate_update"
                                                                            value="" autocomplete="off" required />
                                                                    </div>
                                                                    <div class="form-group col-md-4">
                                                                        <label for="other_fees">autres frais </label>
                                                                        <input name="other_fees" type="number"
                                                                            class="form-control" id="other_fees_update"
                                                                            value="" autocomplete="off" required />
                                                                    </div>
                                                                </div>
                                                                <!--content end here-->
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="hour_rate">Prix d'heure </label>
                                    <input name="hour_rate" type="number" class="form-control" id="hour_rate" value=""
                                        autocomplete="off" required />
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="other_fees">autres frais </label>
                                    <input name="other_fees" type="number" class="form-control" id="other_fees" value=""
                                        autocomplete="off" required />
                                </div>
                            </div>
                            <!--content end here-->
