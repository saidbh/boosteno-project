                            ...
                            <div class="profile-info p-4">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <ul class="nav nav-pills d-flex align-items-end float-right profile-feed-items p-0 m-0">
                                        <li>
                                            <a class="nav-link active" data-toggle="pill" href="#profile-feed">Vue Globale</a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="pill" href="#profile-activity">Détailles</a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="pill" href="#profile-friends">Classes</a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="pill" href="#profile-profile">Timetable</a>
                                        </li>
                                    </ul>
                                </div>
                                </div>
                                ...
                                <div class="iq-card-body">
                                    <div class="user-detail text-center">
                                        ...
                                        <div class="profile-detail mt-3">
                                            <h3 class="d-inline-block">Mohammed amine</h3>
