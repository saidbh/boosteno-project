                                    ...
                                    <div class="row">
                                            ...
                                            <div class="user-detail pl-5">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="profile-detail d-flex align-items-center">
                                                        <h3>{{ $profile->name }} {{ $profile->alter_name }}</h3>
                                                        <!--<p class="m-0 pl-3"></p>-->
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <ul class="nav nav-pills d-flex align-items-end float-right profile-feed-items p-0 m-0">
                                                <li>
                                                    <a class="nav-link active" data-toggle="pill" href="#profile-feed">detailles</a>
                                                </li>
                                                <li>
                                                    <a class="nav-link" data-toggle="pill" href="#profile-activity">Activité</a>
                                                </li>
                                                <li>
