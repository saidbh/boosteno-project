...
class RolePermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('system.role-permission.index', compact('rolesList'));
    }
    ...
    public function create()
    {
        ...
        return view("system.role-permission.create", ['cats'=>$categories, "subcats"=>$subcategories]);
    }
    ...
    public function edit($id)
    {
        ...
        return view("system.role-permission.edit", ["role" => $role, "cats" => $categoriesAccess, "subcats" => $subcategoriesPermissions]);
    }
    ...
    {
        try {
            Permissions::where("roles_id",$id)->delete();
            Access::where("roles_id",$id)->delete();
            UserRole::where('roles_id',$id)->delete();
